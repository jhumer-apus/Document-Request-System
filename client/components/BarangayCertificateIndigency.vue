  ...
  <div>
        ...
        <div class="absolute top-0 right-0 pt-4">
            ...
            <div class="mt-16">
                ...
                <h1 class="variation">(INDIGENCY)</h1>
            </div>
            <div class="grid grid-cols-3 gap-x-8 bg-transparent mt-20">
                ...
                <div class="col-span-2 text-justify pr-16 leading-normal">
                    ...
                    <p class="par_content">This is to certify that {{user.call_address}}. {{user.full_name}}, {{getAge(user.birthdate)}} years old {{user.civil_status}} Filipino citizen and a resident of {{user.purok}}, {{user.barangay}}, {{user.municipality}}, {{user.province}} for___ years more or less.</p><br>

                    <p class="par_content">As per record, the above-mentioned resident is one of the indigent including {{user.pronouns_second}} family living in our barangay. {{user.pronouns}} have never been accused of any crime involving moral turpitude nor a member to any subversive anti-government social organization.</p><br>

                    <p class="par_content"> This certification is upon the request of {{user.full_name}}, {{getAge(user.birthdate)}} years old, ______________ (relation) of the above-mentioned resident for the {{user.purpose}} requirement ONLY.</p><br>
